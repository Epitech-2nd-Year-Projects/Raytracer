...
/**
 * @class DiffuseLightPlugin
 * @brief Plugin for creating a light plugin
 */
class DiffuseLightPlugin : public Plugin::LightPlugin,
                           public Core::IAmbientLight {
public:
  /**
   * @brief Default constructor
   */
  DiffuseLightPlugin() noexcept = default;

  /**
   * @brief Virtual destructor
   */
  ~DiffuseLightPlugin() noexcept override = default;
