...
void assert_point_eq(const Point<3>& p1, const Point<3>& p2, double eps = EQ_APPROX) {
...
void assert_vector_eq(const Vector<3>& v1, const Vector<3>& v2, double eps = EQ_APPROX) {
    for (std::size_t i = 0; i < 3; ++i) {
