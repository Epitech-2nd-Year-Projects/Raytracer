...
constexpr double Color::getB() const noexcept { return m_b.get(); }

constexpr double Color::getG() const noexcept { return m_g.get(); }

constexpr double Color::getR() const noexcept { return m_r.get(); }

void Color::setB(double blue) noexcept { m_b = blue; }

void Color::setG(double green) noexcept { m_g = green; }

void Color::setR(double red) noexcept { m_r = red; }
